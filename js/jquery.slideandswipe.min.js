  ! function(e, s, t, n) {
      ...
      e.fn.slideAndSwipe = function(s) {
          ...
          function i(s, t) {
              a.css("transition-duration", (t / 1e3).toFixed(1) + "s"), s >= 0 && (s = 0), l >= s && (s = l), n() || o() ? a.css("-webkit-transform", "translate(" + s + "px,0)") : a.css("transform", "translate(" + s + "px,0)"), "0" == s && (e(".ssm-toggle-nav").addClass("ssm-nav-visible"), e("html").css("overflow-y", "hidden"), e(".ssm-overlay").fadeIn())
          }
          var a = e(this),
              l = -a.outerWidth(),
              r = l,
          ...
          a.swipe(d);
          var v = function() {
                  a.removeClass("ssm-nav-visible"), i(l, d.speed), e("html").css("overflow-y", "visible"), e(".ssm-overlay").fadeOut(), $('.botao-menu').removeClass('on')
              },
              c = function() {
